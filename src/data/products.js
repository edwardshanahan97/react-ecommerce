export const products = [
  {
    ...
    type: "tops",
    description:
      "A relaxed cotton shirt cut from lightweight fabric with a soft, natural finish.",
    sizes: ["S", "M", "L", "XL"],
    rating: 4.7,
    reviews: 32,
  },

  {
    ...
    type: "trousers",
    description:
      "Relaxed tailored trousers with front pleats and a clean straight-leg silhouette.",
    sizes: ["30", "32", "34", "36"],
    rating: 4.6,
    reviews: 28,
  },

  {
    ...
    type: "bags",
    description:
      "A minimal leather shoulder bag with a curved silhouette and adjustable strap.",
    sizes: ["One Size"],
    rating: 4.8,
    reviews: 41,
  },

  {
    ...
    type: "tops",
    description:
      "A soft ribbed knit top with a relaxed shape designed for effortless layering.",
    sizes: ["XS", "S", "M", "L"],
    rating: 4.5,
    reviews: 19,
  },
  ...
  },
  {
    ...
    type: "skincare",
    description:
      "A lightweight daily moisturiser formulated to hydrate and soften the skin with a smooth, non-greasy finish.",
    sizes: ["50ml"],
    rating: 4.8,
    reviews: 36,
  },
